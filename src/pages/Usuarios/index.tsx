...
import FormularioEquipo from 'C:/Users/Usuario/Documents/GitHub/almacenaudiovisual-frontend/src/layouts/components/FormularioEquipo'; // Import the new form component
...
const Usuario = () => {
  ...
  return (
    <Box sx={{ backgroundColor: "#080808", minHeight: "100vh", color: "#B0BEC5", pt: 8 }}>
      ...
      {/* Sección de Equipos */}
      <Box display="flex" justifyContent="space-between" alignItems="center" sx={{ backgroundColor: "#151E26", p: 2, mb: 2 }}>
          <Typography variant="h5">Mi Equipo</Typography>
          <IconButton color="inherit">
            <ArrowForwardIcon />
          </IconButton>
        </Box>
